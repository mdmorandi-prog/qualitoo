...
const Audits = () => {
  ...
  const handleCreate = async () => {
    ...
    else { toast.success("Auditoria criada!"); setDialogOpen(false); setForm({ title: "", description: "", audit_type: "interna", scheduled_date: "", sector: "", scope: "" }); fetch(); }
  };
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          <DialogTrigger asChild><Button className="gap-2"><Plus className="h-4 w-4" /> Nova Auditoria</Button></DialogTrigger>
