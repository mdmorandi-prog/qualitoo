...
const helpSections: HelpSection[] = [
  {
    id: "geral", title: "Visão Geral", icon: BookOpen, description: "Conceitos gerais do Qualitoo",
    faqs: [
      { question: "O que é o Qualitoo?", answer: "O Qualitoo é uma plataforma de Gestão da Qualidade projetada para instituições de saúde, alinhada com normas de acreditação ONA e JCI. Ele integra todos os processos de qualidade em uma plataforma digital unificada com mais de 30 módulos integrados." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "Como usar a análise de causa raiz por IA?", answer: "Nos detalhes da NC, clique em 'Qualitoo IA'. O assistente analisará a descrição e gerará automaticamente o diagrama de Ishikawa e os 5 Porquês para revisão." },
    ],
  },
  {
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "Como definir política de retenção de um documento?", answer: "Nos detalhes do documento, clique em 'Retenção & Descarte'. Informe o período em meses, a data de início e a base legal (ISO 9001 7.5.3, ANVISA RDC 63/2011, LGPD, CLT, etc.). O sistema calcula automaticamente a data em que o documento fica elegível para descarte e exibe um contador regressivo. Todas as ações ficam registradas na trilha imutável do documento." },
      { question: "O que é Legal Hold (bloqueio legal)?", answer: "Legal Hold impede o descarte de um documento durante litígios judiciais, auditorias externas ou investigações — mesmo que o período de retenção tenha expirado. Ative com um motivo obrigatório; a liberação também gera registro. Enquanto ativo, o botão de descarte fica indisponível." },
      { question: "Como descartar um documento com segurança?", answer: "Após o período de retenção e sem Legal Hold, aparece a opção 'Autorizar descarte' na aba Retenção & Descarte. Selecione o método (exclusão eletrônica segura, anonimização LGPD, trituração física ou arquivo permanente) e informe a justificativa. O documento muda para status 'Descartado' e a trilha de auditoria imutável registra usuário, IP, navegador, horário e snapshot da política vigente — atendendo ISO 9001 e LGPD." },
      { question: "Como assinar com certificado digital ICP-Brasil?", answer: "No diálogo de Assinatura Eletrônica, anexe o arquivo público do seu certificado (.cer, .crt ou .pem) antes de prosseguir. O sistema lê o X.509, confere a vigência, identifica se a cadeia é ICP-Brasil (MP 2.200-2) e exibe titular, emissor, CPF/CNPJ, validade e política. Ao concluir, a assinatura é gravada como 'ICP-Brasil' com esses dados e o hash SHA-256 do documento. O certificado é opcional — recomendado especialmente para contratos." },
      { question: "As etapas de workflow mudaram de lugar?", answer: "Sim. Os workflows de documentos agora rodam no mesmo motor genérico de aprovações usado por NCs, CAPAs e Controle de Mudanças. Na prática nada muda para o usuário: templates, etapas, aprovação/reprovação e o indicador de progresso continuam iguais, mas todas as aprovações do sistema ficam centralizadas em uma única fila auditável." },
      { question: "A trilha de descarte pode ser alterada?", answer: "Não. A tabela `document_disposal_log` é imutável por trigger do banco de dados: qualquer tentativa de UPDATE ou DELETE é rejeitada. Somente administradores e analistas podem consultá-la, garantindo integridade probatória em auditorias e processos legais." },
    ],
  },
  {
    id: "seguranca-acessos", title: "Segurança e Acessos", icon: ShieldCheck, description: "Permissões granulares, portal do fornecedor e assinaturas com certificado",
    faqs: [
      { question: "O que são permissões granulares por ação?", answer: "Além do nível do grupo (Leitura, Escrita, Admin), cada membro pode ter ações específicas liberadas: Consultar, Criar, Editar, Excluir, Aprovar e Exportar. Em Grupos de Acesso, na tabela de membros, basta clicar nas etiquetas de 'Ações permitidas' para ligar ou desligar cada ação. As ações valem para os setores do grupo e ficam registradas na trilha de auditoria." },
      { question: "Trocar o nível do membro apaga as ações personalizadas?", answer: "Sim. Ao alterar o nível (Leitura/Escrita/Admin), o sistema aplica o conjunto padrão de ações daquele nível. Depois disso você pode personalizar novamente. Cada membro precisa manter ao menos uma ação ativa." },
      { question: "Quanto tempo dura o acesso do fornecedor ao portal?", answer: "Os tokens do Portal do Fornecedor têm expiração forçada em 7 dias e são gerados com 256 bits de entropia. Após esse prazo é necessário emitir um novo acesso — o token antigo deixa de funcionar automaticamente." },
      { question: "Existe proteção contra uso abusivo do portal do fornecedor?", answer: "Sim. Cada token é limitado a 30 acessos por hora. Ao ultrapassar o limite, o acesso é bloqueado temporariamente e o bloqueio é registrado. Todos os acessos ficam na 'Trilha de Acessos' dentro dos detalhes do fornecedor, com data, hora, IP e ação realizada." },
      { question: "Como revogar imediatamente o acesso de um fornecedor?", answer: "Abra os detalhes do fornecedor no Portal do Fornecedor e clique em 'Revogar' no token ativo. O acesso é encerrado na hora, a data de revogação é gravada e o evento entra na trilha de auditoria do sistema." },
    ],
  },
  {
  ...
  },
  {
    ...
    faqs: [
      { question: "O que é a Análise Crítica pela Direção?", answer: "É a reunião formal exigida pela ISO 9001:2015 (cláusula 9.3) onde a Alta Direção avalia o desempenho do sistema de qualidade. O módulo estrutura os inputs obrigatórios (status de NCs, auditorias, indicadores, riscos, feedback de clientes, fornecedores, ações anteriores, oportunidades de melhoria e mudanças) e os outputs (decisões, recursos necessários e melhorias)." },
  ...
  },
  {
    ...
    faqs: [
      { question: "Como cadastrar um novo usuário?", answer: "Acesse 'Gerenciamento de Usuários' no menu lateral, clique em 'Novo Usuário'. Preencha: nome de exibição, nome de usuário (formato: inicial + sobrenome, ex: dmorandi), senha temporária e perfil (Administrador ou Analista)." },
